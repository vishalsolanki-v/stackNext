                        ...
                        <div className="flex items-center justify-between">
                            <div className='mb-8 flex flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2'> <Link href={`/profile/${answer?.author?.clerkId}`}
                                ...
                                <div className='flex justify-end'>
                                    <Votes type="Answer" userId={JSON.stringify(userId)} itemId={JSON.stringify(answer?._id)}
                                        hasdownVoted={answer?.downvotes?.includes(userId)} hasupVoted={answer?.upvotes?.includes(userId)}
